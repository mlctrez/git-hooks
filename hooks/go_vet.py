...
def format_files(files=None, from_git=True):
    ...
    for file_in in files:
        ...
        # this works for now, but it would be better to suppres the stderr> prefix
        # produced by hookutils.execute

        outlines = hookutils.execute('go vet %s' % file_in, fail_on_error=False)
